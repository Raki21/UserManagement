...
public class CheckCodeServlet extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        g.fillRect(0,0,width,height);//填充矩形，从（0，0）到（width，height）
        ...
        //2.3 写验证码
        String str = "QWERTYUIOPLKJHGFDSAZXCVBNMqwertyuioplkjhgfdsamnbvcxz1234567890";
        ...
        for (int i = 1; i <= 4; i++) {
            ...
            sb.append(ch);
            g.drawString(ch+"",width/5*i,height/2);//要写入字符串，所以ch+""
        }
